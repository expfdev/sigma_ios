...
- `fetchTimeout: TimeInterval` - таймаут для внутренних запросов SDK к Sigma API. По умолчанию равен 5 секундам. При попытке установить таймаут меньше, чем 0.5 секунд, используется значение по умолчанию (5 секунд)
